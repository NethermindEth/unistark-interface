...
import { colors as ColorsPalette, colorsDark, colorsLight, hexToOpacity } from './colors'
...
function uniswapThemeColors(darkMode: boolean): ThemeColors {
  return {
    ...
    hoverState: hexToOpacity(24, ColorsPalette.blue200),
    hoverDefault: hexToOpacity(8, ColorsPalette.gray200),
...
function oldColors(darkMode: boolean): Colors {
  return {
    ...
    //specialty colors
    deprecated_modalBG: darkMode ? hexToOpacity(40, ColorsPalette.black) : hexToOpacity(30, ColorsPalette.black),
    deprecated_advancedBG: darkMode ? hexToOpacity(10, ColorsPalette.black) : hexToOpacity(60, ColorsPalette.white),
    ...
    deprecated_secondary2: darkMode ? hexToOpacity(25, ColorsPalette.gray900) : '#F6DDE8',
    deprecated_secondary3: darkMode ? hexToOpacity(25, ColorsPalette.gray900) : '#FDEAF1',
...
:root {
  ${({ theme }) => (theme.darkMode ? cssStringFromTheme(themeDark) : cssStringFromTheme(themeLight))}
}
`
