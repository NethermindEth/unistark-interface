...
export const colorsLight: Palette = {
  ...
  backgroundFloating: hexToOpacity(8, colors.gray700),
  backgroundOutline: hexToOpacity(24, colors.gray500),
  backgroundScrim: hexToOpacity(60, colors.gray900),
  backgroundScrolledSurface: hexToOpacity(72, colors.white),
  ...
  accentActionSoft: hexToOpacity(24, colors.pink400),
  accentActiveSoft: hexToOpacity(24, colors.blue400),
  accentSuccessSoft: hexToOpacity(24, colors.green400),
  accentWarningSoft: hexToOpacity(24, colors.gold200),
  accentFailureSoft: hexToOpacity(12, colors.red400),

  accentTextDarkPrimary: hexToOpacity(80, colors.gray900),
  accentTextDarkSecondary: hexToOpacity(60, colors.gray900),
  accentTextDarkTertiary: hexToOpacity(24, colors.gray900),

  accentTextLightPrimary: colors.gray50,
  accentTextLightSecondary: hexToOpacity(60, colors.gray50),
  accentTextLightTertiary: hexToOpacity(12, colors.gray50),
  ...
  stateOverlayHover: hexToOpacity(8, colors.gray300),
  stateOverlayPressed: hexToOpacity(24, colors.gray200),
}
...
export const colorsDark: Palette = {
  ...
  backgroundFloating: hexToOpacity(12, colors.black),
  backgroundOutline: hexToOpacity(14, colors.gray300),
  backgroundScrim: hexToOpacity(72, colors.gray900),
  backgroundScrolledSurface: hexToOpacity(72, colors.gray900),
  ...
  accentActionSoft: hexToOpacity(24, colors.blue400),
  accentActiveSoft: hexToOpacity(24, colors.blue400),
  accentSuccessSoft: hexToOpacity(24, colors.green400),
  accentWarningSoft: hexToOpacity(24, colors.gold200),
  accentFailureSoft: hexToOpacity(12, colors.red400),
  ...
  accentTextLightPrimary: colors.gray50,
  accentTextLightSecondary: hexToOpacity(72, colors.gray50),
  accentTextLightTertiary: hexToOpacity(12, colors.gray50),
...
export function hexToOpacity(amount: number, hexColor: string): string {
