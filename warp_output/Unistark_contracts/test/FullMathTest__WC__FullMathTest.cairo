...
namespace FullMathTest {
    ...
    func s1_mulDiv_aa9a0912{range_check_ptr: felt, bitwise_ptr: BitwiseBuiltin*}(
        ...
        let (__warp_se_2) = warp_mul_unsafe256(__warp_usrid_00_a, __warp_usrid_01_b);

        let __warp_usrid_04_prod0 = __warp_se_2;
        ...
        let (__warp_se_3) = warp_sub_unsafe256(__warp_usrid_05_mm, __warp_usrid_04_prod0);

        let __warp_usrid_06_prod1 = __warp_se_3;

        let (__warp_se_4) = warp_lt256(__warp_usrid_05_mm, __warp_usrid_04_prod0);

        if (__warp_se_4 != 0) {
            let (__warp_se_5) = warp_sub_unsafe256(__warp_usrid_06_prod1, Uint256(low=1, high=0));

            let __warp_usrid_06_prod1 = __warp_se_5;

            let (__warp_se_6) = s1_mulDiv_aa9a0912_if_part1(
            ...
            let (__warp_se_7) = s1_mulDiv_aa9a0912_if_part1(
                __warp_usrid_06_prod1,
                __warp_usrid_02_denominator,
                __warp_usrid_03_result,
                __warp_usrid_04_prod0,
