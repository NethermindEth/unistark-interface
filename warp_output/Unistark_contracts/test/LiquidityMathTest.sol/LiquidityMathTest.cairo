...
namespace LiquidityMathTest{
    ...
    alloc_locals;
        ...
        let __warp_2_z = 0;
            ...
            if (__warp_se_0 != 0){
                ...
                let (__warp_pse_2) = s1_addDelta_402d44fb_if_part1(__warp_2_z);
                ...
                return (__warp_pse_2,);
                    ...
                    let (__warp_pse_3) = warp_add_unsafe128(__warp_0_x, __warp_1_y);
                    
                    let __warp_2_z = __warp_pse_3;
                    
                    let (__warp_se_3) = warp_ge(__warp_pse_3, __warp_0_x);
                    
                    with_attr error_message("LA"){
                        assert __warp_se_3 = 1;
                    }
                
                let (__warp_pse_4) = s1_addDelta_402d44fb_if_part1(__warp_2_z);
    ...
    func s1_addDelta_402d44fb_if_part1(__warp_2_z : felt)-> (__warp_2_z : felt){
    alloc_locals;
