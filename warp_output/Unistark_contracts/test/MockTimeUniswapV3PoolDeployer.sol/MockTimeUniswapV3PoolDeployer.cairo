...
const MockTimeUniswapV3Pool_class_hash_a780c785 = 0;
...
namespace MockTimeUniswapV3PoolDeployer{
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_se_5) = deploy(MockTimeUniswapV3Pool_class_hash_a780c785,__warp_se_3,__warp_se_4.len, __warp_se_4.ptr,0);
