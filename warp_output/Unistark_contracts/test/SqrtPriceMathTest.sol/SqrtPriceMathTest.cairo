...
namespace SqrtPriceMathTest{
    ...
    alloc_locals;
            ...
            let (__warp_se_0) = warp_eq256(__warp_2_amount, Uint256(low=0, high=0));
            ...
            if (__warp_se_0 != 0){
                ...
                let (__warp_pse_5) = getNextSqrtPriceFromAmount0RoundingUp_157f652f_if_part1(__warp_1_liquidity, __warp_3_add, __warp_2_amount, __warp_0_sqrtPX96);
    ...
    func __warp_conditional_getNextSqrtPriceFromAmount0RoundingUp_157f652f_if_part1_1{range_check_ptr : felt}(__warp_8_product : Uint256, __warp_2_amount : Uint256, __warp_0_sqrtPX96 : felt, __warp_5_numerator1 : Uint256)-> (__warp_rc_0 : felt, __warp_8_product : Uint256, __warp_2_amount : Uint256, __warp_0_sqrtPX96 : felt, __warp_5_numerator1 : Uint256){
    alloc_locals;


        
        let (__warp_se_1) = warp_uint256(__warp_0_sqrtPX96);
        
        let (__warp_pse_11) = warp_mul256(__warp_2_amount, __warp_se_1);
        
        let __warp_8_product = __warp_pse_11;
        
        let (__warp_se_2) = warp_div256(__warp_pse_11, __warp_2_amount);
        
        let (__warp_se_3) = warp_uint256(__warp_0_sqrtPX96);
        
        let (__warp_se_4) = warp_eq256(__warp_se_2, __warp_se_3);
        
        if (__warp_se_4 != 0){
        
            
            let (__warp_se_5) = warp_gt256(__warp_5_numerator1, __warp_8_product);
    ...
    alloc_locals;
            ...
            if (__warp_3_add != 0){
                    ...
                    let (__warp_pse_6) = warp_mul_unsafe256(__warp_2_amount, __warp_se_7);
                    
                    let __warp_6_product = __warp_pse_6;
                    
                    let (__warp_se_8) = warp_div_unsafe256(__warp_pse_6, __warp_2_amount);
                    ...
                    if (__warp_se_10 != 0){
                            ...
                            if (__warp_se_11 != 0){
                                    ...
                                    let (__warp_pse_7) = mulDivRoundingUp_0af8b27f(__warp_5_numerator1, __warp_se_12, __warp_7_denominator);
                                    
                                    let (__warp_se_13) = warp_int256_to_int160(__warp_pse_7);
                                ...
                                let (__warp_pse_9) = getNextSqrtPriceFromAmount0RoundingUp_157f652f_if_part1_if_part3(__warp_5_numerator1, __warp_0_sqrtPX96, __warp_2_amount);
                        ...
                        let (__warp_pse_10) = getNextSqrtPriceFromAmount0RoundingUp_157f652f_if_part1_if_part2(__warp_5_numerator1, __warp_0_sqrtPX96, __warp_2_amount);
                    ...
                    let __warp_rc_0 = 0;
                        ...
                        let (__warp_tv_0, __warp_tv_1, __warp_tv_2, __warp_tv_3, __warp_tv_4) = __warp_conditional_getNextSqrtPriceFromAmount0RoundingUp_157f652f_if_part1_1(__warp_8_product, __warp_2_amount, __warp_0_sqrtPX96, __warp_5_numerator1);
                    ...
                    let (__warp_pse_12) = mulDivRoundingUp_0af8b27f(__warp_5_numerator1, __warp_se_14, __warp_9_denominator);
    ...
    alloc_locals;
        ...
        let (__warp_pse_15) = getNextSqrtPriceFromAmount0RoundingUp_157f652f_if_part1_if_part2(__warp_5_numerator1, __warp_0_sqrtPX96, __warp_2_amount);
    ...
    alloc_locals;
            ...
            let (__warp_se_15) = warp_uint256(__warp_0_sqrtPX96);
            
            let (__warp_se_16) = warp_div_unsafe256(__warp_5_numerator1, __warp_se_15);
            
            let (__warp_pse_16) = add_771602f7(__warp_se_16, __warp_2_amount);
            
            let (__warp_pse_17) = divRoundingUp_40226b32(__warp_5_numerator1, __warp_pse_16);
            
            let (__warp_se_17) = warp_int256_to_int160(__warp_pse_17);
    ...
    alloc_locals;
            ...
            if (__warp_13_add != 0){
                    ...
                    if (__warp_se_19 != 0){
                        ...
                        let (__warp_pse_19) = getNextSqrtPriceFromAmount1RoundingDown_fb4de288_if_part2(__warp_10_sqrtPX96, __warp_15_quotient);
                        ...
                        return (__warp_pse_19,);
                            ...
                            let (__warp_pse_20) = mulDiv_aa9a0912(__warp_12_amount, Uint256(low=79228162514264337593543950336, high=0), __warp_se_23);
                            
                            let __warp_15_quotient = __warp_pse_20;
                        
                        let (__warp_pse_21) = getNextSqrtPriceFromAmount1RoundingDown_fb4de288_if_part2(__warp_10_sqrtPX96, __warp_15_quotient);
                    ...
                    let (__warp_se_24) = warp_uint256(1461501637330902918203684832716283019655932542975);
                    
                    let (__warp_se_25) = warp_le256(__warp_12_amount, __warp_se_24);
                    
                    if (__warp_se_25 != 0){
                    
                        
                            
                            let (__warp_se_26) = warp_shl256(__warp_12_amount, 96);
                            
                            let (__warp_se_27) = warp_uint256(__warp_11_liquidity);
                            
                            let (__warp_pse_22) = divRoundingUp_40226b32(__warp_se_26, __warp_se_27);
                            
                            let __warp_16_quotient = __warp_pse_22;
                        
                        let (__warp_pse_23) = getNextSqrtPriceFromAmount1RoundingDown_fb4de288_if_part3(__warp_10_sqrtPX96, __warp_16_quotient);
                        ...
                        return (__warp_pse_23,);
                            ...
                            let (__warp_pse_24) = mulDivRoundingUp_0af8b27f(__warp_12_amount, Uint256(low=79228162514264337593543950336, high=0), __warp_se_28);
                            
                            let __warp_16_quotient = __warp_pse_24;
                        
                        let (__warp_pse_25) = getNextSqrtPriceFromAmount1RoundingDown_fb4de288_if_part3(__warp_10_sqrtPX96, __warp_16_quotient);
    ...
    alloc_locals;
            ...
            let (__warp_se_29) = warp_uint256(__warp_10_sqrtPX96);
            
            let (__warp_se_30) = warp_gt256(__warp_se_29, __warp_16_quotient);
            
            assert __warp_se_30 = 1;
            
            let (__warp_se_31) = warp_uint256(__warp_10_sqrtPX96);
            
            let (__warp_se_32) = warp_sub_unsafe256(__warp_se_31, __warp_16_quotient);
            
            let (__warp_se_33) = warp_int256_to_int160(__warp_se_32);
    ...
    alloc_locals;
            ...
            let (__warp_se_34) = warp_uint256(__warp_10_sqrtPX96);
            
            let (__warp_pse_27) = add_771602f7(__warp_se_34, __warp_15_quotient);
            
            let (__warp_pse_28) = toUint160_dfef6beb(__warp_pse_27);
    ...
    alloc_locals;
        ...
        if (__warp_20_zeroForOne != 0){
            ...
            let (__warp_pse_30) = getNextSqrtPriceFromAmount0RoundingUp_157f652f(__warp_17_sqrtPX96, __warp_18_liquidity, __warp_19_amountIn, 1);
            ...
            let (__warp_pse_31) = getNextSqrtPriceFromAmount1RoundingDown_fb4de288(__warp_17_sqrtPX96, __warp_18_liquidity, __warp_19_amountIn, 1);
    ...
    alloc_locals;
        ...
        if (__warp_24_zeroForOne != 0){
            ...
            let (__warp_pse_32) = getNextSqrtPriceFromAmount1RoundingDown_fb4de288(__warp_21_sqrtPX96, __warp_22_liquidity, __warp_23_amountOut, 0);
            ...
            let (__warp_pse_33) = getNextSqrtPriceFromAmount0RoundingUp_157f652f(__warp_21_sqrtPX96, __warp_22_liquidity, __warp_23_amountOut, 0);
    ...
    alloc_locals;
            ...
            if (__warp_se_39 != 0){
                ...
                let (__warp_pse_34) = s1_getAmount0Delta_2c32d4b6_if_part1(__warp_27_liquidity, __warp_26_sqrtRatioBX96, __warp_25_sqrtRatioAX96, __warp_28_roundUp);
                ...
                let (__warp_pse_35) = s1_getAmount0Delta_2c32d4b6_if_part1(__warp_27_liquidity, __warp_26_sqrtRatioBX96, __warp_25_sqrtRatioAX96, __warp_28_roundUp);
    ...
    func s1_getAmount0Delta_2c32d4b6_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_27_liquidity : felt, __warp_26_sqrtRatioBX96 : felt, __warp_25_sqrtRatioAX96 : felt, __warp_28_roundUp : felt)-> (amount0 : Uint256){
    alloc_locals;
            ...
            if (__warp_28_roundUp != 0){
                    ...
                    let (__warp_pse_36) = mulDivRoundingUp_0af8b27f(__warp_29_numerator1, __warp_30_numerator2, __warp_se_43);
                    
                    let (__warp_se_44) = warp_uint256(__warp_25_sqrtRatioAX96);
                    
                    let (__warp_pse_37) = divRoundingUp_40226b32(__warp_pse_36, __warp_se_44);
                    ...
                    let (__warp_pse_39) = mulDiv_aa9a0912(__warp_29_numerator1, __warp_30_numerator2, __warp_se_45);
                    
                    let (__warp_se_46) = warp_uint256(__warp_25_sqrtRatioAX96);
                    
                    let (__warp_se_47) = warp_div_unsafe256(__warp_pse_39, __warp_se_46);
    ...
    alloc_locals;
            ...
            if (__warp_se_48 != 0){
                ...
                let (__warp_pse_41) = s1_getAmount1Delta_48a0c5bd_if_part1(__warp_34_roundUp, __warp_33_liquidity, __warp_32_sqrtRatioBX96, __warp_31_sqrtRatioAX96);
                ...
                let (__warp_pse_42) = s1_getAmount1Delta_48a0c5bd_if_part1(__warp_34_roundUp, __warp_33_liquidity, __warp_32_sqrtRatioBX96, __warp_31_sqrtRatioAX96);
    ...
    func s1_getAmount1Delta_48a0c5bd_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_34_roundUp : felt, __warp_33_liquidity : felt, __warp_32_sqrtRatioBX96 : felt, __warp_31_sqrtRatioAX96 : felt)-> (amount1 : Uint256){
    alloc_locals;
            ...
            if (__warp_34_roundUp != 0){
                    ...
                    let (__warp_pse_43) = mulDivRoundingUp_0af8b27f(__warp_se_49, __warp_se_51, Uint256(low=79228162514264337593543950336, high=0));
                    ...
                    let (__warp_pse_45) = mulDiv_aa9a0912(__warp_se_52, __warp_se_54, Uint256(low=79228162514264337593543950336, high=0));
    ...
    alloc_locals;
        ...
        let __warp_4_prod0 = Uint256(low=0, high=0);
            ...
            if (__warp_se_57 != 0){
                ...
                let (__warp_pse_55) = mulDiv_aa9a0912_if_part1(__warp_6_prod1, __warp_2_denominator, __warp_3_result, __warp_4_prod0, __warp_0_a, __warp_1_b);
                ...
                let (__warp_pse_56) = mulDiv_aa9a0912_if_part1(__warp_6_prod1, __warp_2_denominator, __warp_3_result, __warp_4_prod0, __warp_0_a, __warp_1_b);
    ...
    alloc_locals;
            ...
            if (__warp_se_59 != 0){
                ...
                let (__warp_pse_58) = mulDiv_aa9a0912_if_part1_if_part1(__warp_2_denominator, __warp_6_prod1, __warp_0_a, __warp_1_b, __warp_4_prod0, __warp_3_result);
    ...
    alloc_locals;
            ...
            if (__warp_se_64 != 0){
                ...
                let (__warp_pse_59) = mulDiv_aa9a0912_if_part1_if_part1_if_part1(__warp_4_prod0, __warp_7_remainder, __warp_2_denominator, __warp_6_prod1, __warp_3_result);
                ...
                let (__warp_pse_60) = mulDiv_aa9a0912_if_part1_if_part1_if_part1(__warp_4_prod0, __warp_7_remainder, __warp_2_denominator, __warp_6_prod1, __warp_3_result);
    ...
    alloc_locals;
        ...
        let (__warp_pse_61) = mulDiv_aa9a0912(__warp_10_a, __warp_11_b, __warp_12_denominator);
        
        let __warp_13_result = __warp_pse_61;
            ...
            if (__warp_se_96 != 0){
                    ...
                    let (__warp_pse_62) = warp_add_unsafe256(__warp_13_result, Uint256(low=1, high=0));
                    
                    let __warp_13_result = __warp_pse_62;
                    
                    warp_sub_unsafe256(__warp_pse_62, Uint256(low=1, high=0));
                
                let (__warp_pse_63) = mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result);
                ...
                let (__warp_pse_64) = mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result);
    ...
    alloc_locals;
        ...
        let __warp_2_z = Uint256(low=0, high=0);
            ...
            if (__warp_se_99 != 0){
                ...
                let (__warp_pse_65) = divRoundingUp_40226b32_if_part1(__warp_2_z, __warp_0_x, __warp_1_y, __warp_3_temp);
                ...
                let (__warp_pse_66) = divRoundingUp_40226b32_if_part1(__warp_2_z, __warp_0_x, __warp_1_y, __warp_3_temp);
    ...
    alloc_locals;
        ...
        let __warp_2_z = Uint256(low=0, high=0);
            ...
            let (__warp_se_102) = warp_ge256(__warp_pse_67, __warp_0_x);
    ...
    alloc_locals;
        ...
        let (__warp_pse_72) = warp_int256_to_int160(__warp_0_y);
        
        let __warp_1_z = __warp_pse_72;
        
        let (__warp_se_103) = warp_uint256(__warp_pse_72);
