...
namespace TickTest{
    ...
    alloc_locals;
        ...
        if (__warp_se_45 != 0){
                ...
                if (__warp_se_46 != 0){
                    ...
                    let (__warp_pse_3) = update_3bf3_if_part2(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
                    ...
                    let (__warp_pse_4) = update_3bf3_if_part2(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
            ...
            let (__warp_pse_5) = update_3bf3_if_part1(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
    ...
    alloc_locals;
        ...
        let (__warp_pse_6) = update_3bf3_if_part1(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
    ...
    alloc_locals;
        ...
        if (__warp_28_upper != 0){
                ...
                let (__warp_pse_7) = sub_adefc37b(__warp_se_56, __warp_se_57);
                
                let (__warp_pse_8) = toInt128_dd2a0316(__warp_pse_7);
                
                let (__warp_se_58) = WSM1_Info_39bc053d_liquidityNet(__warp_31_info);
                
                WS_WRITE1(__warp_se_58, __warp_pse_8);
            ...
            return (__warp_30_flipped,);
                ...
                let (__warp_pse_9) = add_a5f3c23b(__warp_se_61, __warp_se_62);
                
                let (__warp_pse_10) = toInt128_dd2a0316(__warp_pse_9);
                
                let (__warp_se_63) = WSM1_Info_39bc053d_liquidityNet(__warp_31_info);
                
                WS_WRITE1(__warp_se_63, __warp_pse_10);
    ...
    alloc_locals;
        ...
        let __warp_2_z = 0;
            ...
            if (__warp_se_87 != 0){
                    ...
                    let (__warp_pse_11) = warp_sub_unsafe128(__warp_0_x, __warp_se_88);
                    
                    let __warp_2_z = __warp_pse_11;
                    
                    let (__warp_se_89) = warp_lt(__warp_pse_11, __warp_0_x);
                    
                    with_attr error_message("LS"){
                        assert __warp_se_89 = 1;
                    }
                
                let (__warp_pse_12) = addDelta_402d44fb_if_part1(__warp_2_z);
                ...
                return (__warp_pse_12,);
                    ...
                    let (__warp_pse_13) = warp_add_unsafe128(__warp_0_x, __warp_1_y);
                    
                    let __warp_2_z = __warp_pse_13;
                    
                    let (__warp_se_90) = warp_ge(__warp_pse_13, __warp_0_x);
                    
                    with_attr error_message("LA"){
                        assert __warp_se_90 = 1;
                    }
                
                let (__warp_pse_14) = addDelta_402d44fb_if_part1(__warp_2_z);
    ...
    alloc_locals;
        ...
        let (__warp_pse_16) = warp_int256_to_int128(__warp_2_y);
        
        let __warp_3_z = __warp_pse_16;
        
        let (__warp_se_91) = warp_int128_to_int256(__warp_pse_16);
    ...
    alloc_locals;
        ...
        let __warp_11_z = Uint256(low=0, high=0);
            ...
            let (__warp_pse_20) = warp_add_signed_unsafe256(__warp_9_x, __warp_10_y);
            
            let __warp_11_z = __warp_pse_20;
            
            let (__warp_se_93) = warp_ge_signed256(__warp_pse_20, __warp_9_x);
    ...
    alloc_locals;
        ...
        let __warp_14_z = Uint256(low=0, high=0);
            ...
            let (__warp_pse_21) = warp_sub_signed_unsafe256(__warp_12_x, __warp_13_y);
            
            let __warp_14_z = __warp_pse_21;
            
            let (__warp_se_96) = warp_le_signed256(__warp_pse_21, __warp_12_x);
