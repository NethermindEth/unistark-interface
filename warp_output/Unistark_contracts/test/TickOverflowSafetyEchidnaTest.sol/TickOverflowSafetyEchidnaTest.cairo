...
namespace TickOverflowSafetyEchidnaTest{
            ...
            if (__warp_se_1 != 0){
                    ...
                    if (__warp_se_3 != 0){
                            ...
                            if (__warp_se_9 != 0){
                                ...
                                let (__warp_pse_0) = __warp_while17_if_part3(__warp_15_target);
                                ...
                                let (__warp_pse_1) = __warp_while17_if_part3(__warp_15_target);
                            ...
                            let (__warp_se_17) = WS0_INDEX_felt_to_Info_39bc053d(__warp_1_ticks, __warp_se_16);
                            
                            let (__warp_se_18) = WSM0_Info_39bc053d_liquidityGross(__warp_se_17);
                            
                            let (__warp_se_19) = WS0_READ_felt(__warp_se_18);
                            
                            let (__warp_se_20) = warp_gt(__warp_se_19, 0);
                            
                            if (__warp_se_20 != 0){
                            
                                
                                    
                                    let (__warp_se_21) = WS0_READ_felt(__warp_2_tick);
                                    
                                    let (__warp_se_22) = WS1_READ_Uint256(__warp_4_feeGrowthGlobal0X128);
                                    
                                    let (__warp_se_23) = WS1_READ_Uint256(__warp_5_feeGrowthGlobal1X128);
                                    
                                    let (__warp_se_24) = warp_block_timestamp();
                                    
                                    let (__warp_se_25) = warp_int256_to_int32(__warp_se_24);
                                    
                                    cross_5d47(__warp_1_ticks, __warp_se_21, __warp_se_22, __warp_se_23, 0, 0, __warp_se_25);
                                
                                let (__warp_pse_2) = __warp_while17_if_part4(__warp_15_target);
                                ...
                                let (__warp_pse_3) = __warp_while17_if_part4(__warp_15_target);
    ...
    func __warp_while17_if_part4{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_15_target : felt)-> (__warp_15_target : felt){
    alloc_locals;


        
            
            let (__warp_se_26) = WS0_READ_felt(__warp_2_tick);
            
            let (__warp_se_27) = warp_sub_signed24(__warp_se_26, 1);
            
            let (__warp_se_28) = WS_WRITE0(__warp_2_tick, __warp_se_27);
            
            warp_add_signed24(__warp_se_28, 1);
        
        let (__warp_pse_5) = __warp_while17_if_part2(__warp_15_target);
    ...
    func __warp_while17_if_part3{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_15_target : felt)-> (__warp_15_target : felt){
    alloc_locals;
            ...
            let (__warp_se_30) = warp_add_signed24(__warp_se_29, 1);
            
            let (__warp_se_31) = WS_WRITE0(__warp_2_tick, __warp_se_30);
            
            warp_sub_signed24(__warp_se_31, 1);
        
        let (__warp_pse_6) = __warp_while17_if_part2(__warp_15_target);
    ...
    func __warp_while17_if_part2{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_15_target : felt)-> (__warp_15_target : felt){
    alloc_locals;
        ...
        let (__warp_pse_7) = __warp_while17_if_part1(__warp_15_target);
    ...
    func __warp_while17_if_part1{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_15_target : felt)-> (__warp_15_target : felt){
    alloc_locals;
        ...
        let (__warp_pse_8) = __warp_while17(__warp_15_target);
    ...
    func setPosition_541bdfb1_if_part2{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_14_flippedUpper : felt, __warp_12_liquidityDelta : felt, __warp_11_tickUpper : felt)-> (){
    alloc_locals;
        ...
        setPosition_541bdfb1_if_part1(__warp_14_flippedUpper, __warp_12_liquidityDelta, __warp_11_tickUpper);
    ...
    func setPosition_541bdfb1_if_part1{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_14_flippedUpper : felt, __warp_12_liquidityDelta : felt, __warp_11_tickUpper : felt)-> (){
    alloc_locals;
        ...
        if (__warp_14_flippedUpper != 0){
                ...
                if (__warp_se_72 != 0){
                        ...
                        let (__warp_se_73) = WS0_INDEX_felt_to_Info_39bc053d(__warp_1_ticks, __warp_11_tickUpper);
                        ...
                        clear_db51(__warp_1_ticks, __warp_11_tickUpper);
                    
                    setPosition_541bdfb1_if_part1_if_part2(__warp_12_liquidityDelta);
                    ...
                    return ();
                        ...
                        let (__warp_se_77) = WS0_INDEX_felt_to_Info_39bc053d(__warp_1_ticks, __warp_11_tickUpper);
            ...
            setPosition_541bdfb1_if_part1_if_part1(__warp_12_liquidityDelta);
    ...
    func setPosition_541bdfb1_if_part1_if_part2{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_12_liquidityDelta : felt)-> (){
    alloc_locals;
    ...
    func setPosition_541bdfb1_if_part1_if_part1{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_12_liquidityDelta : felt)-> (){
    alloc_locals;


        
        let (__warp_se_81) = WS1_READ_Uint256(__warp_3_totalLiquidity);
        ...
        WS_WRITE1(__warp_3_totalLiquidity, __warp_se_83);
        
        let (__warp_se_84) = WS1_READ_Uint256(__warp_3_totalLiquidity);
        
        let (__warp_se_85) = warp_ge_signed256(__warp_se_84, Uint256(low=0, high=0));
        
        assert __warp_se_85 = 1;
        
        let (__warp_se_86) = WS1_READ_Uint256(__warp_3_totalLiquidity);
    ...
    alloc_locals;
        ...
        if (__warp_se_98 != 0){
                ...
                if (__warp_se_99 != 0){
                    ...
                    let (__warp_pse_10) = update_3bf3_if_part2(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
                    ...
                    let (__warp_pse_11) = update_3bf3_if_part2(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
            ...
            let (__warp_pse_12) = update_3bf3_if_part1(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
    ...
    alloc_locals;
        ...
        let (__warp_pse_13) = update_3bf3_if_part1(__warp_31_info, __warp_33_liquidityGrossAfter, __warp_28_upper, __warp_22_liquidityDelta, __warp_30_flipped);
    ...
    alloc_locals;
        ...
        if (__warp_28_upper != 0){
                ...
                let (__warp_pse_14) = sub_adefc37b(__warp_se_109, __warp_se_110);
                
                let (__warp_pse_15) = toInt128_dd2a0316(__warp_pse_14);
                
                let (__warp_se_111) = WSM7_Info_39bc053d_liquidityNet(__warp_31_info);
                
                WS_WRITE0(__warp_se_111, __warp_pse_15);
            ...
            return (__warp_30_flipped,);
                ...
                let (__warp_pse_16) = add_a5f3c23b(__warp_se_114, __warp_se_115);
                
                let (__warp_pse_17) = toInt128_dd2a0316(__warp_pse_16);
                
                let (__warp_se_116) = WSM7_Info_39bc053d_liquidityNet(__warp_31_info);
                
                WS_WRITE0(__warp_se_116, __warp_pse_17);
    ...
    alloc_locals;
        ...
        let __warp_2_z = 0;
            ...
            if (__warp_se_140 != 0){
                    ...
                    let (__warp_pse_18) = warp_sub_unsafe128(__warp_0_x, __warp_se_141);
                    
                    let __warp_2_z = __warp_pse_18;
                    
                    let (__warp_se_142) = warp_lt(__warp_pse_18, __warp_0_x);
                    
                    with_attr error_message("LS"){
                        assert __warp_se_142 = 1;
                    }
                
                let (__warp_pse_19) = addDelta_402d44fb_if_part1(__warp_2_z);
                ...
                return (__warp_pse_19,);
                    ...
                    let (__warp_pse_20) = warp_add_unsafe128(__warp_0_x, __warp_1_y);
                    
                    let __warp_2_z = __warp_pse_20;
                    
                    let (__warp_se_143) = warp_ge(__warp_pse_20, __warp_0_x);
                    
                    with_attr error_message("LA"){
                        assert __warp_se_143 = 1;
                    }
                
                let (__warp_pse_21) = addDelta_402d44fb_if_part1(__warp_2_z);
    ...
    alloc_locals;
        ...
        let (__warp_pse_23) = warp_int256_to_int128(__warp_2_y);
        
        let __warp_3_z = __warp_pse_23;
        
        let (__warp_se_144) = warp_int128_to_int256(__warp_pse_23);
    ...
    alloc_locals;
        ...
        let __warp_11_z = Uint256(low=0, high=0);
            ...
            let (__warp_pse_27) = warp_add_signed_unsafe256(__warp_9_x, __warp_10_y);
            
            let __warp_11_z = __warp_pse_27;
            
            let (__warp_se_146) = warp_ge_signed256(__warp_pse_27, __warp_9_x);
    ...
    alloc_locals;
        ...
        let __warp_14_z = Uint256(low=0, high=0);
            ...
            let (__warp_pse_28) = warp_sub_signed_unsafe256(__warp_12_x, __warp_13_y);
            
            let __warp_14_z = __warp_pse_28;
            
            let (__warp_se_149) = warp_le_signed256(__warp_pse_28, __warp_12_x);
    ...
    alloc_locals;
        ...
        if (__warp_13_flippedLower != 0){
                ...
                if (__warp_se_63 != 0){
                    ...
                    TickOverflowSafetyEchidnaTest.setPosition_541bdfb1_if_part2(__warp_14_flippedUpper, __warp_12_liquidityDelta, __warp_11_tickUpper);
            ...
            TickOverflowSafetyEchidnaTest.setPosition_541bdfb1_if_part1(__warp_14_flippedUpper, __warp_12_liquidityDelta, __warp_11_tickUpper);
    ...
    alloc_locals;
        ...
        let (__warp_pse_9) = TickOverflowSafetyEchidnaTest.__warp_while17(__warp_15_target);
        
        let __warp_15_target = __warp_pse_9;
