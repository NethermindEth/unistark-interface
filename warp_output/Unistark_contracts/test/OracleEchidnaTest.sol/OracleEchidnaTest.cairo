...
const OracleTest_class_hash_17bd7136 = 0;
...
namespace OracleEchidnaTest{
    ...
    alloc_locals;
        ...
        let (__warp_se_1) = deploy(OracleTest_class_hash_17bd7136,0,__warp_se_0.len, __warp_se_0.ptr,0);
    ...
    func echidna_canAlwaysObserve0IfInitialized_ae505b52_if_part1{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*}()-> (__warp_24 : felt){
    alloc_locals;
        ...
        let (__warp_se_24) = WS0_READ_felt(__warp_0_oracle);
    ...
    alloc_locals;
        ...
        if (__warp_se_26 != 0){
            ...
            let (__warp_pse_8) = OracleTest_warped_interface.index_2986c0e5(__warp_se_27);
            
            let (__warp_se_28) = warp_add16(__warp_pse_8, 1);
    ...
    func __warp_conditional_checkTimeWeightedAveragesAlwaysFitsType_a9583576_if_part1_9{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_43_timeWeightedTick : felt)-> (__warp_rc_8 : felt, __warp_43_timeWeightedTick : felt){
    alloc_locals;


        
        let (__warp_se_56) = warp_int24_to_int56(8388607);
        
        let (__warp_se_57) = warp_le_signed56(__warp_43_timeWeightedTick, __warp_se_56);
        
        if (__warp_se_57 != 0){
        
            
            let (__warp_se_58) = warp_int24_to_int56(8388608);
            
            let (__warp_se_59) = warp_ge_signed56(__warp_43_timeWeightedTick, __warp_se_58);
            
            let __warp_rc_8 = __warp_se_59;
    ...
    func checkTimeWeightedAveragesAlwaysFitsType_a9583576_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*}(__warp_43_timeWeightedTick : felt, __warp_38_secondsAgo : felt, __warp_41_secondsPerLiquidityCumulativeX128s : felt)-> (){
    alloc_locals;
        ...
        let __warp_rc_8 = 0;
            ...
            let (__warp_tv_10, __warp_tv_11) = __warp_conditional_checkTimeWeightedAveragesAlwaysFitsType_a9583576_if_part1_9(__warp_43_timeWeightedTick);
    ...
    with warp_memory{
        ...
        if (1 - __warp_se_22 != 0){
            ...
            let (__warp_pse_7) = OracleEchidnaTest.echidna_canAlwaysObserve0IfInitialized_ae505b52_if_part1();
    ...
    alloc_locals;
        ...
        let (__warp_pse_9) = OracleEchidnaTest.conditional_349fe82b(__warp_26_index, __warp_27_cardinality);
        
        let (__warp_se_32) = WS0_READ_felt(OracleEchidnaTest.__warp_0_oracle);
        
        let (__warp_se_33) = warp_uint256(__warp_pse_9);
    ...
    with warp_memory{
        ...
        let (__warp_se_46) = WS0_READ_felt(OracleEchidnaTest.__warp_1_initialized);
        
        assert __warp_se_46 = 1;
        
        let (__warp_se_47) = warp_gt(__warp_38_secondsAgo, 0);
        
        assert __warp_se_47 = 1;
        
        let (__warp_39_secondsAgos) = wm_new(Uint256(low=2, high=0), Uint256(low=1, high=0));
        
        let (__warp_se_48) = wm_index_dyn(__warp_39_secondsAgos, Uint256(low=0, high=0), Uint256(low=1, high=0));
        
        wm_write_felt(__warp_se_48, __warp_38_secondsAgo);
        
        let (__warp_se_49) = wm_index_dyn(__warp_39_secondsAgos, Uint256(low=1, high=0), Uint256(low=1, high=0));
        
        wm_write_felt(__warp_se_49, 0);
        
        let (__warp_se_50) = WS0_READ_felt(OracleEchidnaTest.__warp_0_oracle);
        
        let (__warp_se_51) = wm_to_calldata0(__warp_39_secondsAgos);
        
        let (__warp_td_2_cd_raw_len, __warp_td_2_cd_raw, __warp_td_3_cd_raw_len, __warp_td_3_cd_raw) = OracleTest_warped_interface.observe_883bdbfd(__warp_se_50, __warp_se_51.len, __warp_se_51.ptr);
        ...
        let (__warp_se_52) = wm_index_dyn(__warp_40_tickCumulatives, Uint256(low=1, high=0), Uint256(low=1, high=0));
        
        let (__warp_se_53) = wm_read_felt(__warp_se_52);
        
        let (__warp_se_54) = wm_index_dyn(__warp_40_tickCumulatives, Uint256(low=0, high=0), Uint256(low=1, high=0));
        
        let (__warp_se_55) = wm_read_felt(__warp_se_54);
        
        let (__warp_42_numerator) = warp_sub_signed56(__warp_se_53, __warp_se_55);
        ...
        if (__warp_rc_6 != 0){
                ...
                let (__warp_pse_10) = warp_sub_signed56(__warp_43_timeWeightedTick, 1);
                
                let __warp_43_timeWeightedTick = __warp_pse_10;
                
                warp_add_signed56(__warp_pse_10, 1);
            
            OracleEchidnaTest.checkTimeWeightedAveragesAlwaysFitsType_a9583576_if_part1(__warp_43_timeWeightedTick, __warp_38_secondsAgo, __warp_41_secondsPerLiquidityCumulativeX128s);
