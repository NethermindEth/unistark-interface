...
namespace TestUniswapV3Router{
    ...
    func uniswapV3SwapCallback_fa461e33_if_part2{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*}(__warp_9_amount1Delta : Uint256, __warp_8_amount0Delta : Uint256, __warp_13_tokenToBePaid : felt, __warp_11_pool : felt, __warp_12_payer : felt)-> (){
    alloc_locals;
            ...
            if (__warp_se_20 != 0){
                ...
                uniswapV3SwapCallback_fa461e33_if_part2_if_part1(__warp_13_tokenToBePaid, __warp_11_pool, __warp_14_amountToBePaid, __warp_12_payer);
    ...
    func uniswapV3SwapCallback_fa461e33_if_part2_if_part1{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*}(__warp_13_tokenToBePaid : felt, __warp_11_pool : felt, __warp_14_amountToBePaid : Uint256, __warp_12_payer : felt)-> (){
    alloc_locals;


        
            
            let (__warp_pse_5) = IUniswapV3Pool_warped_interface.token1_d21220a7(__warp_11_pool);
            
            let (__warp_15_zeroForOne) = warp_eq(__warp_13_tokenToBePaid, __warp_pse_5);
            
            let (__warp_pse_6) = conditional_9077f189(__warp_15_zeroForOne);
            
            let (__warp_se_21) = get_caller_address();
            
            let (__warp_se_22) = warp_negate256(__warp_14_amountToBePaid);
            
            let (__warp_se_23) = abi_encode0(__warp_11_pool, __warp_12_payer);
            
            let (__warp_se_24) = wm_to_calldata0(__warp_se_23);
            
            IUniswapV3Pool_warped_interface.swap_128acb08(__warp_11_pool, __warp_se_21, __warp_15_zeroForOne, __warp_se_22, __warp_pse_6, __warp_se_24.len, __warp_se_24.ptr);
    ...
    with warp_memory, keccak_ptr{
        ...
        if (__warp_se_11 != 0){
                ...
                if (__warp_se_13 != 0){
                    ...
                    TestUniswapV3Router.uniswapV3SwapCallback_fa461e33_if_part2(__warp_9_amount1Delta, __warp_8_amount0Delta, __warp_13_tokenToBePaid, __warp_11_pool, __warp_12_payer);
                ...
                if (__warp_se_15 != 0){
                        ...
                        let (__warp_pse_3) = IUniswapV3Pool_warped_interface.token0_0dfe1681(__warp_se_16);
                        
                        let (__warp_se_17) = get_caller_address();
                        
                        IERC20Minimal_warped_interface.transferFrom_23b872dd(__warp_pse_3, __warp_12_payer, __warp_se_17, __warp_8_amount0Delta);
                    ...
                    return ();
                        ...
                        let (__warp_pse_4) = IUniswapV3Pool_warped_interface.token1_d21220a7(__warp_se_18);
                        
                        let (__warp_se_19) = get_caller_address();
                        
                        IERC20Minimal_warped_interface.transferFrom_23b872dd(__warp_pse_4, __warp_12_payer, __warp_se_19, __warp_9_amount1Delta);
