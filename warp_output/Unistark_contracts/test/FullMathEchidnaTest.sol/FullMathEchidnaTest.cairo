...
namespace FullMathEchidnaTest{
    ...
    func checkMulDiv_bf08c391_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_8_z : Uint256, __warp_7_d : Uint256, __warp_6_y : Uint256, __warp_5_x : Uint256)-> (){
    alloc_locals;


        
        let (__warp_9_x2) = mulDiv_aa9a0912(__warp_8_z, __warp_7_d, __warp_6_y);
        
        let (__warp_10_y2) = mulDiv_aa9a0912(__warp_8_z, __warp_7_d, __warp_5_x);
    ...
    func checkMulDivRoundingUp_79eee487_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_14_z : Uint256, __warp_13_d : Uint256, __warp_12_y : Uint256, __warp_11_x : Uint256)-> (){
    alloc_locals;


        
        let (__warp_15_x2) = mulDiv_aa9a0912(__warp_14_z, __warp_13_d, __warp_12_y);
        
        let (__warp_16_y2) = mulDiv_aa9a0912(__warp_14_z, __warp_13_d, __warp_11_x);
    ...
    alloc_locals;
        ...
        let __warp_4_prod0 = Uint256(low=0, high=0);
            ...
            if (__warp_se_28 != 0){
                ...
                let (__warp_pse_0) = mulDiv_aa9a0912_if_part1(__warp_6_prod1, __warp_2_denominator, __warp_3_result, __warp_4_prod0, __warp_0_a, __warp_1_b);
                ...
                let (__warp_pse_1) = mulDiv_aa9a0912_if_part1(__warp_6_prod1, __warp_2_denominator, __warp_3_result, __warp_4_prod0, __warp_0_a, __warp_1_b);
    ...
    alloc_locals;
            ...
            if (__warp_se_30 != 0){
                ...
                let (__warp_pse_3) = mulDiv_aa9a0912_if_part1_if_part1(__warp_2_denominator, __warp_6_prod1, __warp_0_a, __warp_1_b, __warp_4_prod0, __warp_3_result);
    ...
    alloc_locals;
            ...
            if (__warp_se_35 != 0){
                ...
                let (__warp_pse_4) = mulDiv_aa9a0912_if_part1_if_part1_if_part1(__warp_4_prod0, __warp_7_remainder, __warp_2_denominator, __warp_6_prod1, __warp_3_result);
                ...
                let (__warp_pse_5) = mulDiv_aa9a0912_if_part1_if_part1_if_part1(__warp_4_prod0, __warp_7_remainder, __warp_2_denominator, __warp_6_prod1, __warp_3_result);
    ...
    alloc_locals;
        ...
        let (__warp_pse_6) = mulDiv_aa9a0912(__warp_10_a, __warp_11_b, __warp_12_denominator);
        
        let __warp_13_result = __warp_pse_6;
            ...
            if (__warp_se_67 != 0){
                    ...
                    let (__warp_pse_7) = warp_add_unsafe256(__warp_13_result, Uint256(low=1, high=0));
                    
                    let __warp_13_result = __warp_pse_7;
                    
                    warp_sub_unsafe256(__warp_pse_7, Uint256(low=1, high=0));
                
                let (__warp_pse_8) = mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result);
                ...
                let (__warp_pse_9) = mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result);
    ...
    alloc_locals;
        ...
        if (__warp_rc_0 != 0){
            ...
            FullMathEchidnaTest.checkMulDiv_bf08c391_if_part1(__warp_8_z, __warp_7_d, __warp_6_y, __warp_5_x);
    ...
    alloc_locals;
        ...
        if (__warp_rc_2 != 0){
            ...
            FullMathEchidnaTest.checkMulDivRoundingUp_79eee487_if_part1(__warp_14_z, __warp_13_d, __warp_12_y, __warp_11_x);
