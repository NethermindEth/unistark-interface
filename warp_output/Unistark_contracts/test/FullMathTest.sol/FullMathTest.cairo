...
namespace FullMathTest{
    ...
    alloc_locals;
        ...
        let __warp_4_prod0 = Uint256(low=0, high=0);
            ...
            if (__warp_se_2 != 0){
                ...
                let (__warp_pse_2) = s1_mulDiv_aa9a0912_if_part1(__warp_6_prod1, __warp_2_denominator, __warp_3_result, __warp_4_prod0, __warp_0_a, __warp_1_b);
                ...
                let (__warp_pse_3) = s1_mulDiv_aa9a0912_if_part1(__warp_6_prod1, __warp_2_denominator, __warp_3_result, __warp_4_prod0, __warp_0_a, __warp_1_b);
    ...
    func s1_mulDiv_aa9a0912_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_6_prod1 : Uint256, __warp_2_denominator : Uint256, __warp_3_result : Uint256, __warp_4_prod0 : Uint256, __warp_0_a : Uint256, __warp_1_b : Uint256)-> (__warp_3_result : Uint256){
    alloc_locals;
            ...
            if (__warp_se_4 != 0){
                ...
                let (__warp_pse_5) = s1_mulDiv_aa9a0912_if_part1_if_part1(__warp_2_denominator, __warp_6_prod1, __warp_0_a, __warp_1_b, __warp_4_prod0, __warp_3_result);
    ...
    func s1_mulDiv_aa9a0912_if_part1_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_2_denominator : Uint256, __warp_6_prod1 : Uint256, __warp_0_a : Uint256, __warp_1_b : Uint256, __warp_4_prod0 : Uint256, __warp_3_result : Uint256)-> (__warp_3_result : Uint256){
    alloc_locals;
            ...
            if (__warp_se_9 != 0){
                ...
                let (__warp_pse_6) = s1_mulDiv_aa9a0912_if_part1_if_part1_if_part1(__warp_4_prod0, __warp_7_remainder, __warp_2_denominator, __warp_6_prod1, __warp_3_result);
                ...
                let (__warp_pse_7) = s1_mulDiv_aa9a0912_if_part1_if_part1_if_part1(__warp_4_prod0, __warp_7_remainder, __warp_2_denominator, __warp_6_prod1, __warp_3_result);
    ...
    func s1_mulDiv_aa9a0912_if_part1_if_part1_if_part1{range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*}(__warp_4_prod0 : Uint256, __warp_7_remainder : Uint256, __warp_2_denominator : Uint256, __warp_6_prod1 : Uint256, __warp_3_result : Uint256)-> (__warp_3_result : Uint256){
    alloc_locals;
    ...
    alloc_locals;
        ...
        let (__warp_pse_8) = mulDiv_aa9a0912(__warp_10_a, __warp_11_b, __warp_12_denominator);
        
        let __warp_13_result = __warp_pse_8;
            ...
            if (__warp_se_41 != 0){
                    ...
                    let (__warp_pse_9) = warp_add_unsafe256(__warp_13_result, Uint256(low=1, high=0));
                    
                    let __warp_13_result = __warp_pse_9;
                    
                    warp_sub_unsafe256(__warp_pse_9, Uint256(low=1, high=0));
                
                let (__warp_pse_10) = s1_mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result);
                ...
                let (__warp_pse_11) = s1_mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result);
    ...
    func s1_mulDivRoundingUp_0af8b27f_if_part1(__warp_13_result : Uint256)-> (__warp_13_result : Uint256){
    alloc_locals;
