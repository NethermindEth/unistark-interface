...
namespace TestUniswapV3Callee{
    ...
    func uniswapV3MintCallback_d3487997_if_part1{syscall_ptr : felt*, range_check_ptr : felt}(__warp_32_amount1Owed : Uint256, __warp_34_sender : felt)-> (){
    alloc_locals;
    ...
    func uniswapV3FlashCallback_e9cbafb0_if_part1{syscall_ptr : felt*, range_check_ptr : felt}(__warp_46_pay1 : Uint256, __warp_44_sender : felt)-> (){
    alloc_locals;
    ...
    with warp_memory, keccak_ptr{
        ...
        if (__warp_se_33 != 0){
            ...
            TestUniswapV3Callee.uniswapV3MintCallback_d3487997_if_part1(__warp_32_amount1Owed, __warp_34_sender);
    ...
    with warp_memory, keccak_ptr{
        ...
        if (__warp_se_43 != 0){
            ...
            TestUniswapV3Callee.uniswapV3FlashCallback_e9cbafb0_if_part1(__warp_46_pay1, __warp_44_sender);
