...
const UniswapV3Pool_class_hash_f8613222 = 0;
...
namespace UniswapV3Factory{
    ...
    alloc_locals;
        ...
        if (__warp_se_1 != 0){
            ...
            let (__warp_pse_1) = __warp_original_function_createPool_a1671295_0_if_part1(__warp_7_token0, __warp_5_fee, __warp_8_token1, __warp_6_pool);
            ...
            let (__warp_pse_2) = __warp_original_function_createPool_a1671295_0_if_part1(__warp_7_token0, __warp_5_fee, __warp_8_token1, __warp_6_pool);
    ...
    func __warp_original_function_createPool_a1671295_0_if_part1{syscall_ptr : felt*, pedersen_ptr : HashBuiltin*, range_check_ptr : felt, bitwise_ptr : BitwiseBuiltin*, warp_memory : DictAccess*, keccak_ptr : felt*}(__warp_7_token0 : felt, __warp_5_fee : felt, __warp_8_token1 : felt, __warp_6_pool : felt)-> (__warp_6_pool : felt){
    alloc_locals;
        ...
        let (__warp_pse_3) = deploy_fad5359f(__warp_se_12, __warp_7_token0, __warp_8_token1, __warp_5_fee, __warp_9_tickSpacing);
        
        let __warp_6_pool = __warp_pse_3;
    ...
    alloc_locals;
        ...
        let (__warp_se_60) = deploy(UniswapV3Pool_class_hash_f8613222,__warp_se_58,__warp_se_59.len, __warp_se_59.ptr,0);
    ...
    with warp_memory, keccak_ptr{
        ...
        let (__warp_pse_4) = UniswapV3Factory.__warp_modifier_noDelegateCall_createPool_a1671295_6(__warp_3_tokenA, __warp_4_tokenB, __warp_5_fee, __warp_6_pool);
